...
void SensorSetReg_MT9V111(UINT8 uAddr, UINT16 uVal)
{
...
void SensorSetReg_OV7649(UINT8 uAddr, UINT16 uVal)
{
...
void SensorSetReg_OV7660(UINT8 uAddr, UINT16 uVal)
{
	V5B_SifI2cWriteByte((UINT8)uAddr, (UINT8)uVal);
}
...
void SensorSetReg_OV7670(UINT8 uAddr, UINT16 uVal)
...
void SensorSetReg_HV7131GP(UINT8 uAddr, UINT16 uVal)
{
         V5B_SifI2cWriteByte((UINT8)uAddr, (UINT8)uVal);
}
...
void SensorSetReg_HV7131RP(UINT8 uAddr, UINT16 uVal)
{
         V5B_SifI2cWriteByte((UINT8)uAddr, (UINT8)uVal);
}
...
void SensorSetReg_NOON30PC11(UINT8 uAddr, UINT16 uVal)
...
void SensorSetReg_S5K83A(UINT8 uAddr, UINT16 uVal)
{
         V5B_SifI2cWriteByte((UINT8)uAddr, (UINT8)uVal);
}
...
void SensorSetReg_MC501CB(UINT8 uAddr, UINT16 uVal)
{
         V5B_SifI2cWriteByte((UINT8)uAddr, (UINT8)uVal);
}
...
void SensorSetReg_PO3030K(UINT8 uAddr, UINT16 uVal)
{
         V5B_SifI2cWriteByte((UINT8)uAddr, (UINT8)uVal);
}
...
void SensorSetReg_SIV100A(UINT8 uAddr, UINT16 uVal)
{
         V5B_SifI2cWriteByte((UINT8)uAddr, (UINT8)uVal);
}
...
void SensorSetReg_OV6680(UINT8 uAddr, UINT16 uVal)
...
void SensorSetReg_SP80818(UINT8 uAddr, UINT16 uVal)
...
void SensorSetReg_MT9V112(UINT8 uAddr, UINT16 uVal)
{
         V5B_SifI2cWriteWord((UINT8)uAddr, (UINT16)uVal);
}
...
UINT8 CheckId_MT9V112(void)
{
     ...
     //Uart_Printf("\n **** Enter	MT9V112 CheckID Function !! ***** \n");
     //Uart_Printf("\n Sensor ID is 0x%x !! ***** \n", temp);
...
void SensorSetReg_GC306(UINT8 uAddr, UINT16 uVal)
{
         V5B_SifI2cWriteByte((UINT8)uAddr, (UINT8)uVal);
}
...
{      	
	...
	{0x40, 0x7e, 1}, //0x7c  Lens Correction enable //fengyu
	{0x41, 0x9f, 1}, //0x3F
	{0x42, 0x30, 1},
	{0x43, 0x40, 1},
	{0x44, 0xe2, 1},
	...
	{0x55, 0xa0, 1},
	{0x56, 0xc0, 1},
	{0x57, 0xe0, 1},   //  0x58,0xff,  //²»ÄÜÐ´£¡  
    
	{0x59, 0x00, 1},  //offset grG
	{0x5a, 0x00, 1},  //offset R
	{0x5b, 0x00, 1},  //offset B
	{0x5c, 0x00, 1},  //offset bgG
   
	{0x61, 0x60, 1},  //manual gain grG
	{0x63, 0x6a, 1},  //manual gain R
	{0x65, 0x78, 1},  //manual gain B
	{0x67, 0x60, 1},  //manual gain bgG
	...
	{0xc8, 0x00, 1},
	{0xc9, 0x00, 1},
	{0xca, 0x50, 1},  //40, Red Channel Manual Gain
	{0xcb, 0x40, 1},
	{0xcc, 0x40, 1},
	{0xcd, 0x40, 1},
	{0xce, 0x40, 1},
...
void SensorSetReg_OM6802(UINT8 uAddr, UINT16 uVal)
{
         V5B_SifI2cWriteByte((UINT8)uAddr, (UINT8)uVal);
}
