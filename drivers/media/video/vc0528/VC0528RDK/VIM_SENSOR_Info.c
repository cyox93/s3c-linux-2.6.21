...
const TReg gSnrSizeRegValVGA_SIV120D[] =
{
	//bank0
	{0x00,0x00,0},
	{0x04,0x00,0}, // valiable v sync mode
//	{0x04,0x80,0},   // fix 30f v sync fix mode
	{0x05,0x03,0},
	{0x10,0x34,0},
	{0x11,0x27,0},
	{0x12,0x21,0},
	...
	{0x20,0x00,0},	//P_BNKT
	{0x21,0x01,0},	//P_HBNKT
	{0x22,0x01,0},	//P_ROWFIL
	{0x23,0x01,0},	//P_VBNKT


	//bank1:AE
	{0x00,0x01,0},
//	{0x11,0x1e,0},  // 4fps at lowlux
//	{0x11,0x14,0},  // 6fps at lowlux
//	{0x11,0x0c,0},  // 10fps at lowlux
//	{0x11,0x08,0},  // 15fps at lowlux
	{0x11,0x06,0},  // 20fps at lowlux
//	{0x11,0x04,0},  // 30fps at lowlux
	{0x12,0x78,0},	// D65 target 0x74
	{0x13,0x78,0},	// CWF target 0x74
	{0x14,0x78,0},	// A target   0x74
	{0x1E,0x08,0},	// ini gain	0x08
	{0x34,0x7d,0},  //
	{0x40,0x60,0}, 	// Max x6

 	{0x41,0x20,0},  //AG_TOP1  0x28
 	{0x42,0x20,0},  //AG_TOP0  0x28
	{0x43,0x00,0},  //AG_MIN1  0x08
 	{0x44,0x00,0},  //AG_MIN0  0x08
	{0x45,0x00,0},  //G50_dec  0x09
	{0x46,0x0a,0},  //G33_dec  0x17
	{0x47,0x10,0},  //G25_dec  0x1d
	{0x48,0x13,0},  //G20_dec  0x21
	{0x49,0x15,0},  //G12_dec  0x23
	{0x4a,0x18,0},  //G09_dec  0x24
	{0x4b,0x1a,0},  //G06_dec  0x26
	{0x4c,0x1d,0},  //G03_dec  0x27
	{0x4d,0x20,0},  //G100_inc 0x27
	{0x4e,0x10,0},  //G50_inc  0x1a
	{0x4f,0x0a,0},  //G33_inc  0x14
	{0x50,0x08,0},  //G25_inc  0x11
	{0x51,0x06,0},  //G20_inc  0x0f
	{0x52,0x05,0},  //G12_inc  0x0d
	{0x53,0x04,0},  //G09_inc  0x0c
	{0x54,0x02,0},  //G06_inc  0x0a
	{0x55,0x01,0},  //G03_inc  0x09
	...
	{0x13,0x80,0},
	{0x14,0x80,0},
	{0x15,0xfe,0},	// R gain Top
	{0x16,0x80,0},	// R gain bottom
	{0x17,0xcb,0},	// B gain Top
	{0x18,0x80,0},	// B gain bottom 0x80
	{0x19,0x94,0},	// Cr top value 0x90
	{0x1a,0x6c,0},	// Cr bottom value 0x70
	{0x1b,0x94,0},	// Cb top value 0x90
	{0x1c,0x6c,0},	// Cb bottom value 0x70
	{0x1d,0x94,0},	// 0xa0
	{0x1e,0x6c,0},	// 0x60
	{0x20,0xe8,0},	// AWB luminous top value
	{0x21,0x30,0},	// AWB luminous bottom value 0x20
	{0x22,0xa4,0},
	{0x23,0x20,0},
	{0x25,0x20,0},
	{0x26,0x0f,0},
	{0x27,0x60,0},	// BRTSRT
	{0x28,0xcb,0},	// BRTRGNTOP result 0xad
//*	{0x29,0xa0,0},	// BRTRGNBOT
	{0x29,0xc8,0},	// BRTRGNBOT
	{0x2a,0xa0,0},	// BRTBGNTOP result 0x90
	{0x2b,0x98,0},  // BRTBGNBOT
	{0x2c,0x88,0},	// RGAINCONT
	{0x2d,0x88,0},	// BGAINCONT
	...
	{0x63,0xb3,0},	// R D30 to D20
	{0x64,0xc3,0},	// B D30 to D20
	{0x65,0xb3,0},	// R D20 to D30
	{0x66,0xc3,0},	// B D20 to D30

	{0x67,0xdd,0},	// R D65 to D30
	{0x68,0xa0,0},	// B D65 to D30
	{0x69,0xdd,0},	// R D30 to D65
	{0x6a,0xa0,0},	// B D30 to D65
	...
	{0x11,0x0d,0},
	{0x12,0x3d,0},
	{0x14,0x04,0}, // don't change

	{0xc0,0x24,0}, // windows size define
	{0xc1,0x00,0},
	{0xc2,0x80,0},
	{0xc3,0x00,0},
	{0xc4,0xe0,0},
	...
	//DPCNR
	{0x17,0x28,0},  // DPCNRCTRL
	{0x18,0x04,0},  // DPTHR
	{0x19,0x50,0},  // C DP Number ( Normal [7:6] Dark [5:4] ) | [3:0] DPTHRMIN
	{0x1A,0x50,0},  // G DP Number ( Normal [7:6] Dark [5:4] ) | [3:0] DPTHRMAX
	{0x1B,0x12,0},  // DPTHRSLP( [7:4] @ Normal | [3:0] @ Dark )
	{0x1C,0x00,0},  // NRTHR
	{0x1D,0x0f,0},  // [5:0] NRTHRMIN 0x48
	{0x1E,0x0f,0},  // [5:0] NRTHRMAX 0x48
	{0x1F,0x3f,0},  // NRTHRSLP( [7:4] @ Normal | [3:0] @ Dark )	0x2f
	{0x20,0x04,0},  // IllumiInfo STRTNOR
	{0x21,0x0f,0},  // IllumiInfo STRTDRK
	{0x2f,0x80,0},  // add bank3
	...
	{0x44,0x33,0},
	{0x45,0x11,0},
	{0x46,0x11,0},	// left R gain[7:4], right R gain[3:0]
	{0x47,0x22,0},	// top R gain[7:4], bottom R gain[3:0]
	{0x48,0x01,0},	// left Gr gain[7:4], right Gr gain[3:0] 0x21
	{0x49,0x01,0},	// top Gr gain[7:4], bottom Gr gain[3:0]
	{0x4a,0x01,0},	// left Gb gain[7:4], right Gb gain[3:0] 0x02
	{0x4b,0x01,0},	// top Gb gain[7:4], bottom Gb gain[3:0]
	{0x4c,0x12,0},	// left B gain[7:4], right B gain[3:0]
	{0x4d,0x10,0},	// top B gain[7:4], bottom B gain[3:0]
	{0x4e,0x04,0},	// X-axis center high[3:2], Y-axis center high[1:0]
	{0x4f,0x50,0},	// X-axis center low[7:0] 0x50
	{0x50,0xf8,0},	// Y-axis center low[7:0] 0xf6
	{0x51,0x80,0},	// Shading Center Gain
	{0x52,0x00,0},	// Shading R Offset
	{0x53,0x00,0},	// Shading Gr Offset
	{0x54,0x00,0},	// Shading Gb Offset
	{0x55,0x00,0},	// Shading B Offset
	//Interpolation
/*
	{0x60,0x57,0},	//INT outdoor condition
	{0x61,0x57,0},	//INT normal condition
*/
	{0x62,0x77,0},	//ASLPCTRL 7:4 GE, 3:0 YE
	{0x63,0xb7,0},	//YDTECTRL (YE) [7] fixed,
	{0x64,0xb7,0},	//GPEVCTRL (GE) [7] fixed,
/*
	{0x66,0x0c,0},	//SATHRMIN
	{0x67,0xff,0},
	{0x68,0x04,0},	//SATHRSRT
	{0x69,0x08,0},	//SATHRSLP

	{0x6a,0xaf,0},	//PTDFATHR [7] fixed, [5:0] value
	{0x6b,0x60,0},	//PTDLOTHR [6] fixed, [5:0] value
*/
	{0x6d,0x88,0},	//YFLTCTRL
	...
	{0x8c,0x10,0},	//CMA select

	{0x8d,0x04,0},	//programmable edge
	{0x8e,0x02,0},	//PROGEVAL
	{0x8f,0x00,0},	//Cb/Cr coring assignme

	{0x90,0x10,0},	//GEUGAIN
	{0x91,0x10,0},	//GEDGAIN
	{0x92,0x02,0},	//Ucoring [7:4] max, [3:0] min
//	{0x94,0x02,0},	//Uslope (1/128)
//*	{0x96,0xf0,0},	//Dcoring [7:4] max, [3:0] min
	{0x96,0x02,0},	//Dcoring [7:4] max, [3:0] min

	{0x9f,0x0c,0},	//YEUGAIN
	{0xa0,0x0c,0},	//YEDGAIN
	{0xa1,0x22,0},	//Yecore [7:4]upper [3:0]down

	{0xa9,0x0f,0},	// Cr saturation 0x12
	{0xaa,0x12,0},	// Cb saturation 0x12
	{0xab,0x82,0},	// Brightness
	{0xae,0x40,0},	// Hue
	{0xaf,0x86,0},	// Hue
	{0xb9,0x10,0},	// 0x20 lowlux color
	{0xba,0x20,0},	// 0x10 lowlux color
